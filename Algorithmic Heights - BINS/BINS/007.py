...
Dictionary search - use defaultdict to handle missing values
"""
...
def lookup(dataDict, value):
    return defaultdict(defaultFactory, dataDict)[value]
...
with open('results_hash3.txt', 'w') as resultsfile:
